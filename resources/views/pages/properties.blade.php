				...
				<table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
					...
					<tbody>
						@foreach($properties as $property)
							<tr class="link_to_member" link="{{$property->id}}">
								...
								<td>
									<a data-toggle="modal" data-target="#myModal{{$property->id}}" class="btn btn-success">
												...
												<div class="row">
													<div class="col-xs-12">
														<fieldset class="form-group">
															...
															<input type="text" class="form-control" placeholder="{{ $property['user']->name }}" name="name" id="date-mask-input" data-validation="optional">
														</fieldset>
													</div>
													<div class="col-lg-12">
														<fieldset class="form-group">
															<label class="form-label" >Occupant's Email</label>
															<input type="text" class="form-control" placeholder="{{ $property['user']->email }}" name="email" id="date-mask-input" data-validation="optional email">
														</fieldset>
													</div>
												</div><!--.row-->
													...
													<div class="row">
														<div class="col-xs-12">
															<fieldset class="form-group">
																...
																<textarea rows="5" class="form-control " name= "description" placeholder="{{ $property->descripion }}"maxlength="300"></textarea>
															</fieldset>
														</div>
														<div class="col-lg-12">
															<fieldset class="form-group">
													...
													<div class="row">
														...
														<div class="col-lg-12">
															<fieldset class="form-group">
																...
																<input type="number" class="form-control" placeholder="{{ $property->price }}" name="rent_paid" data-validation="required" required>
															</fieldset>
														</div>
														<div class="col-lg-12">
															<fieldset class="form-group">
