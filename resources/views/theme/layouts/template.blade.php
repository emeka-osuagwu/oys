...
<!-- Mirrored from themesanytime.com/startui/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Mar 2016 12:38:59 GMT -->
<head lang="ru">
	<meta charset="UTF-8">
	...
	<link href="{{URL::asset('img/favicon.144x144.html')}}" rel="apple-touch-icon" type="image/png" sizes="144x144">
	<link href="{{URL::asset('img/favicon.114x114.html')}}" rel="apple-touch-icon" type="image/png" sizes="114x114">
	<link href="{{URL::asset('img/favicon.72x72.html')}}" rel="apple-touch-icon" type="image/png" sizes="72x72">
	<link href="{{URL::asset('img/favicon.57x57.html')}}" rel="apple-touch-icon" type="image/png">
	<link href="{{URL::asset('img/favicon.html')}}" rel="icon" type="image/png">
	<link href="{{URL::asset('img/favicon-2.html')}}" rel="shortcut icon">
	...
	<script type="text/javascript" src="{{URL::asset('www.gstatic.com/charts/loader.js')}}"></script>
...
<!-- Mirrored from themesanytime.com/startui/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Mar 2016 12:39:36 GMT -->
</html>